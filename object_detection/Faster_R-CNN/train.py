...
from utils import utils, callbacks
from frcnn import FasterRCNN
from frcnn_training import weights_init, get_lr_scheduler, FasterRCNNTrainer
import os
import torch
import numpy as np
...
if __name__ == "__main__":
    ...
    class_names, num_classes = utils.get_classes(classes_path)
    ...
    loss_history = callbacks.LossHistory(log_dir, model, input_shape=input_shape)
